...
<div class="container py-4">
    <?= view('reports/_topbar', [
        'subtitle' => 'Relatorio de Appliances agrupado por gerencia.',
        'activeMenu' => 'relatorios',
        'activeSubmenu' => 'appliances',
        'breadcrumbs' => [
            ['label' => 'Início', 'url' => site_url('/')],
            ['label' => 'Relatórios'],
            ['label' => 'Appliances', 'active' => true],
        ],
    ]) ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped align-middle">
                                        ...
                                        <?php foreach ($day['items'] as $row): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= site_url('reports/appliances/detail?date=' . urlencode($day['reference_date']) . '&gerencia=' . urlencode($row['gerencia'])) ?>">
                                                        <?= esc($row['gerencia']) ?>
                                                    </a>
                                                </td>
